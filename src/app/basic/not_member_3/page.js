...
import TableUi_2_a from '@/components/common/TableUi_2_a';
        ...
        <section className='HBox mt-[72px]'>
          <div className='Inner'>
            <article className='CenterCenter gap-[10px]'>
              ...
              <div>
                <button className='Button_1 Xl w-[245px]' disabled>문의수정</button>
              </div>
            </article>
          </div>
        </section>
        <section className='HBox mt-[72px]'>
          <div className='Inner'>
            <article className='CenterCenter gap-[10px]'>
              ...
              <div>
                <button className='Button_1 Xl w-[245px]'>문의 저장</button>
              </div>
            </article>
          </div>
        </section>
        <section className='HBox mt-[128px]'>
          <div className='Inner'>
