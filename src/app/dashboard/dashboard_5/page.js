            ...
            <div className={`border-t-[1px] border-t-[#E0DFEA] p-[16px]`}>
              <article className={`flex flex-row gap-[14px]`}>
                <div className={`Fc w-[75.28%]`}>
                  ...
                  <div className={`DataGrid_1`}>
                    <div className={`GridHead`}>
                      <table>
                        <colgroup>
                          <col className={`w-[6.99%]`}/>
                          <col className={``}/>
                          <col className={`w-[12.15%]`}/>
                          <col className={`w-[12.15%]`}/>
                          <col className={`w-[9.11%]`}/>
                          <col className={`w-[32.52%]`}/>
                        </colgroup>
                        <thead>
                          <tr>
                            <th>순위</th>
                          ...
                          {[...Array(30).keys()].map((obj, idx) => {
                            return (
                              <Fragment key={idx}>
                                <tr>
                                  <td>{idx + 1}</td>
                                  <td className={`!text-left`}>키워드1</td>
                                  <td>422,000</td>
                                  <td>422,000</td>
                                  <td>$ 100</td>
                                  <td>
                                    <article className={`CenterCenter gap-[4px]`}>
                                      ...
                                      <div className={`ml-[4px] text-[#5D45FF] text-[12px] font-[400] leading-[12px]`}>
                                        +5
                                      </div>
                                    </article>
                                  </td>
                ...
                <div className={`Fc flex-1`}>
                  ...
                  <article className={`h-[412px] CenterCenter rounded-[12px] border-solid border-[1px] border-[#E0DFEA] bg-[#F0EFF6]`}>
                    <div className={`text-center text-[#A3A1B1] text-[14px] font-[500] leading-[24px]`}>
                      키워드를 클릭하면
                      <br/>
                      상세정보가 표시됩니다.
                    </div>
              ...
              <div className={`border-solid border-[1px] border-[#E0DFEA] rounded-[12px]`}>
                ...
                <div className={`border-t-[1px] border-t-[#E0DFEA] p-[16px]`}>
                  <div className={`text-[#A3A1B1] text-[14px] font-[500] leading-[24px]`}>
                    마음에 드는 페르소나를 선택하면, 컨텐츠 이미지를 생성할때 요소로 활용할 수 있습니다.
                  </div>
                  <article className={`mt-[20px]`}>
                    <button className={`Button_4 w-full`} disabled={true}>
                      생성하기
                    </button>
                  </article>
                </div>
